...
namespace TimeReporter.Models
{
    public class TimeReporterContext : DbContext
    {
        ...
        public DbSet<AcceptedTime> Accepted {get; set;}
        ...
        private void InitialMigration(ModelBuilder mb)
        {
            ...
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
                AcceptedTimeId = 2, Time = 110, ReportId = 1, ActivityId = 7, WorkerId = 1
            });
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
                AcceptedTimeId = 3, Time = 25, ReportId = 1, ActivityId = 3, WorkerId = 1
            });
            
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
                AcceptedTimeId = 4, Time = 100, ReportId = 4, ActivityId = 2, WorkerId = 4
            });
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
            ...
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
                AcceptedTimeId = 6, Time = 110, ReportId = 4, ActivityId = 7, WorkerId = 4
            });
            mb.Entity<AcceptedTime>().HasData(new AcceptedTime()
            {
                AcceptedTimeId = 7, Time = 160, ReportId = 4, ActivityId = 5, WorkerId = 4
            });
